...
RUN apt-get update && apt-get install -y python3 && apt-get install -y python3-pip && apt autoremove && apt autoclean && apt-get clean packages && pip3 install -r requirements.txt
